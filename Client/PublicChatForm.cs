...
namespace Client
{
    public partial class PublicChatForm : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Text = "Pulic Chat - " + formLogin.txtIP.Text + " - (Connected as: " + formLogin.txtNickname.Text + ")";
        ...
        public void _client_Received(ClientSettings cs, string received)
        {
            ...
            switch (cmd[0])
            {
                ...
                case "pMessage":
                    this.Invoke(() =>
                    {
                        pChat.z.Text += "Server says: " + cmd[1] + "\r\n";
                    });
                    break;
                case "Disconnect":
                    Application.Exit();
        ...
        private void PublicChatForm_VisibleChanged(object sender, EventArgs e)
        {
        }
